...
const Userprojects = () => {
    ...
    useEffect(() => {
        ...
        fetch("/api/IssueTracker/userprojects", requestOptions)
    ...
    const Userprojectstablecard = () => {
        ...
        return (
            ...
            <Card className={classes.root} variant="outlined">
                <CardContent>
                    <div id="subheaders">
                        <CardHeader disableTypography={true} title="Assigned Projects"
                        ...
                        <p className={classes.subheader}> Your Projects </p>
                    </div>
        ...
        <div>
...

            {
                projects.forEach(function (element) {
                    projectstable.push({ projectsname: element.projectsname, description: element.description })
                })
            }
            {
                projects.forEach(function (element) {
                ...
                <div class="d-flex" id="wrapper">
                    ...
                    <div id="page-content-wrapper" style={{ color: "#lightgray" }}>
                        <div class="container-fluid">
                            ...
                            <h3 id="main"> Assigned Projects </h3>
                            <br>
                            </br>
                            <Userprojectstablecard/>

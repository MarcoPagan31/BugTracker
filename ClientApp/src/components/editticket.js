...
const EditTicket = () => {
    ...
    const editticket = () => {
        const requestOptions = {
            ...
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                oldTitle: location.state.title.current,
                title: title,
                submitter: submitter,
                developer: developer,
                priority: priority,
        ...
        fetch("/api/Ticket/editticket", requestOptions)
            .then((response) => response.json())
            .then((data) => {
                    ...
                    <div class="container-fluid">
                        ...
                        <div id="select" class="wrapper">
                            <Card className={classes.root} variant="outlined">
                                <CardContent>
                                    <div id="subheaders">
                                        <CardHeader disableTypography={true} title="Edit Ticket"
                                ...
                                <div class="form-group form-inline"> 
                                    ...
                                    <TextField size="small"  variant="outlined" placeholder={location.state.title.current} class="box" type="text" onChange={(e) => setTitle(e.target.value)} />
                                    <br>
                                    </br>
                                    <br>
                                    </br>
                                    <label id="labels" style={{ marginRight: '10px' }}> Submitter: </label>
                                    <TextField size="small"  variant="outlined" placeholder={location.state.submitter} class="box" type="text" onChange={(e) => setSubmitter(e.target.value)} />
                                    <br>
                                    </br>
                                    <br>
                                    </br>
                                    <label id="labels" style={{ marginRight: '10px' }}> Developer: </label>
                                    <TextField size="small"  variant="outlined" placeholder={location.state.developer} class="box" onChange={(e) => setDeveloper(e.target.value)} />
                                    <br>
                                    </br>
                                    <br>
                                    </br>
                                    <label id="labels" style={{ marginRight: '10px' }}> Priority: </label>
                                    <TextField size="small"  variant="outlined" placeholder={location.state.priority.current} class="box" onChange={(e) => setPriority(e.target.value)} />
                                    <br>
                                    </br>
                                    <br>
                                    </br>
                                    <label id="labels" style={{ marginRight: '10px' }}> Type: </label>
                                    <TextField size="small"  variant="outlined" placeholder={location.state.type.current} class="box" onChange={(e) => setType(e.target.value)} />
                                    <br>
                                    </br>
                                    <br>
                                    </br>
                                    <label id="labels" style={{ marginRight: '10px' }}> Status: </label>
                                    <TextField size="small"  variant="outlined" placeholder={location.state.status.current} class="box" onChange={(e) => setStatus(e.target.value)} />
                                </div>
                                <button class="btn btn-secondary" onClick={() => editticket()}> Save Changes </button>
                                </CardContent>
                            </Card>
                        </div>
                    </div>

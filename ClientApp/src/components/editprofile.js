...
const Profile = () => {
    ...
    const editprofile = () => {
        ...
        fetch("/api/IssueTracker/editprofile", requestOptions)
            .then((response) => response.json())
            .then((data) => {
                ...
                <div id="page-content-wrapper" style={{ color: "#lightgray" }}>
                    ...
                    <div id="select" class="wrapper">
                        <Card className={classes.root} variant="outlined">
                            <CardContent>
                                <CardHeader disableTypography={true} title="Edit Profile"
                                ...
                                <TextField size="small" variant="outlined" placeholder={user.applicationUserusername} onChange={(e) => setUsername(e.target.value)}/>
                                <br>
                                </br>
                                <br>
                                </br>
                                <label id="labels" style={{ marginRight: '10px' }}> Email: </label>
                                <TextField size="small" variant="outlined" placeholder={user.email} onChange={(e) => setEmail(e.target.value)}/>
                                <br>
                                </br>
                                <br>
                                </br>
                                <label id="labels" style={{ marginRight: '10px' }}> Password: </label>
                                <TextField size="small" variant="outlined" placeholder={user.password} onChange={(e) => setPassword(e.target.value)}/>
                                <br>
                                </br>
                                <br>
                                </br>

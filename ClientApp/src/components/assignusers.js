...
const Assignusers = () => {
    ...
    const handleChange = obj => {
        ...
        setTicketTitle(location.state.title);
    }
    ...
    useEffect(() => {
        const requestOptions = {
            ...
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                ApplicationUserId: location.state.userId
            }),
        };
    ...
    const post = () => {
        const requestOptions = {
            ...
            body: JSON.stringify({
                ...
                TicketsId: location.state.TicketsId.current,
                ApplicationUserId: userId.current
            }),
        };
        fetch("/api/IssueTracker/addusertoticket", requestOptions)
            .then((response) => response.text())
            .then((data) => {
    ...
    const removeUser = () => {
        ...
        fetch("/api/IssueTracker/removeuserfromticket", requestOptions)
            .then((response) => response.text())
            .then((data) => {
            ...
            <div class="d-flex" id="wrapper">
                ...
                <div id="page-content-wrapper" style={{ color: "#lightgray" }}>
                    <div class="container-fluid">
                        ...
                        <h3 id="main"> Manage Ticket Users </h3>
                        <div id="select" class="wrapper">
                            <Card className={classes.root} variant="outlined">
                                <CardContent>
                                    <CardHeader disableTypography={true} title="Assign a User" style={{ align: "center", fontSize: "20px" }} id="subheadersmain" class="p-3 mb-2 bg-info text-white"> Create a New Ticket </CardHeader>
                            ...
                            <Card className={classes.root} variant="outlined">
                                <CardContent>
                                    <CardHeader disableTypography={true} title="Remove a User" style={{ align: "center", fontSize: "20px" }} id="subheadersmain" class="p-3 mb-2 bg-info text-white"> Create a New Ticket </CardHeader>
                        ...
                        <div class="wrapper">
                            <Card className={classes.root} variant="outlined">
                                <CardContent>
                                    <CardHeader disableTypography={true} title="Your Personnel" style={{ align: "center", fontSize: "20px" }} id="subheadersmain" class="p-3 mb-2 bg-info text-white"> </CardHeader>
                                    <p className={classes.subheader}> All of the users in your database </p>
